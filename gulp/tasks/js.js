module.exports = (function() {
	...
	paths.js.modernizr = {
		src: paths.bower.foundation.src + 'js/vendor/modernizr.js'
	};
	...
	ops.js.buildVendor = function(taskName, src, dest, options) {
		var gulpStream;
		...
		return ops.js.minify(gulpStream, options.mangle, dest);
	};

	ops.js.minify = function(gulpStream, mangle, dest) {
		return gulpStream
